...
% This function is about making lists
%
% @summary This function makes a List of size N
% @author Sebastien Doeraene
% @param N size of the list
% @since 15-12-2012
% @version 3
% @todo Update the file with more comments
% @todo Write pre and post of MakeList
fun {MakeList N}
   if N>0 then _|{MakeList N-1} else nil end
end

% This function informs the user whether or not the argument is a list
%
% @todo Write pre and post of IsList
fun {IsList Xs}
